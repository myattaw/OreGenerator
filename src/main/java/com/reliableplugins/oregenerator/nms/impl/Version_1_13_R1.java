...
public class Version_1_13_R1 implements NMSHandler {
    ...
    public void breakBlock(Block block, Player player) {
        ...
        net.minecraft.server.v1_13_R1.EntityPlayer entityPlayer = ((CraftPlayer) player).getHandle();
        net.minecraft.server.v1_13_R1.World world = ((CraftWorld) block.getWorld()).getHandle();
        ...
        if (nmsBlock.n(nmsBlock.getBlockData()).isAlwaysDestroyable() || (itemType != null && itemType.canDestroySpecialBlock(nmsBlock.getBlockData()))) {
            ...
            net.minecraft.server.v1_13_R1.ItemStack mainItem = entityPlayer.getEquipment(EnumItemSlot.MAINHAND);
